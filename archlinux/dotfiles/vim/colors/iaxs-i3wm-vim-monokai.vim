...
hi SpellBad     guisp=#F92672 gui=none term=none cterm=none
hi SpellCap     guisp=#65D9EF gui=none term=none cterm=none
hi SpellRare    guisp=#AE81FF gui=none term=none cterm=none
...
hi RedR    guifg=fg guibg=#F92672 gui=bold term=bold cterm=bold
